...
// article 작성 날짜 형식 변경
let noticeArticles = document.querySelectorAll('.article-created_at');
for(const articleCreatedTime of noticeArticles) {
    articleCreatedTime.innerHTML = articleCreatedTime.textContent.slice(0, 10);
}
